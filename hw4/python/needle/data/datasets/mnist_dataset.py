...
import gzip
import struct
# import sys; sys.path.append("/content/drive/MyDrive/10714/hw4/python/needle/backend_ndarray")
# from ndarray import NDArray
# import sys; sys.path.append("/content/drive/MyDrive/10714/hw4/python/")
# import needle
...
class MNISTDataset(Dataset):
    def __init__(
        ...
        #image_content = NDArray(image_content, device=needle.cpu())
        ...
        #self.label_content = NDArray(self.label_content, device=needle.cpu())
